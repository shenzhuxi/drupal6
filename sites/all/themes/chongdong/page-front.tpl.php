...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>">
  <head>
	...
	<script type="text/javascript" src="<?php print base_path().path_to_theme(); ?>/js/cycle.js"></script>
    <script type="text/javascript" src="<?php print base_path().path_to_theme(); ?>/js/custom.js"></script>
    <script type="text/javascript" src="<?php print base_path().path_to_theme(); ?>/js/today.js"></script>
    <script type="text/javascript">
    $(document).ready(function() {
			
            $('#slides .view-content').cycle({ 
                fx:    'fade',
                pager: '.controls .control_tab'
            });
			var aWidth = 0;
			$(".controls div.control_tab a").each(function(i){
				aWidth = aWidth + $(this).width()+10;
			});
			aWidth = aWidth*(-1)/2;
			$(".controls div.control_tab").css({"margin-left":aWidth+"px"}); 
			
			$("#featuredimage .views-row").wrapInner("<div class='featuredtext'></div>")
            $("#featuredimage .view-content").cycle({ 
                fx:    'fade'
            });
...
<div id="wrapper">
  ...
  <div id="bottomsection">
    <div id="newsbox">
      <h2><a href="<?php print base_path()?>companynews">虫洞新闻</a></h2>
      <div class="controls">
        <div class="control_tab"></div>
      </div>
      <div id="slides">
          <?php print $newsbox; ?>
       </div>
